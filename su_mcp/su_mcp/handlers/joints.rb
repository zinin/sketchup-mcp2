    ...
    module Joints
      ...
      def self.create_mortise_tenon(params)
        ...
        begin
          ...
          {
            "mortise" => SU_MCP::Handlers::Geometry.describe_entity(mortise_board),
            "tenon"   => SU_MCP::Handlers::Geometry.describe_entity(tenon_board)
          }
        rescue StandardError
          SU_MCP::Handlers::Geometry.safe_abort(model)
          raise
        end
      end
      ...
      def self.create_dovetail(params)
        ...
        begin
          ...
          model.commit_operation
          {
            "tail" => SU_MCP::Handlers::Geometry.describe_entity(tail),
            "pin"  => SU_MCP::Handlers::Geometry.describe_entity(pin)
          }
        rescue StandardError
          SU_MCP::Handlers::Geometry.safe_abort(model)
          raise
      ...
      def self.create_finger_joint(params)
        ...
        begin
          ...
          model.commit_operation
          {
            "board1" => SU_MCP::Handlers::Geometry.describe_entity(b1),
            "board2" => SU_MCP::Handlers::Geometry.describe_entity(b2)
          }
        rescue StandardError
          SU_MCP::Handlers::Geometry.safe_abort(model)
          raise
      ...
      def self.place_tenon(board, w, h, d, face_dir, ox, oy, oz)
        ...
        origin   = face_origin(face_dir, board.bounds, w, h, ox, oy, oz)
        prot     = SU_MCP::Helpers::Entities.active_model!.active_entities.add_group
        begin
